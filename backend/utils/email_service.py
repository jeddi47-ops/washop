...
Add SENDGRID_API_KEY to .env to activate real email sending.
"""
import os
import logging
...
def _wrap_html(body_content: str, preview_text: str = "") -> str:
    """Wrap email body in a professionally designed HTML template."""
...
def _stat_card(label: str, value: str) -> str:
    """Generate a single stat block for stats emails."""
