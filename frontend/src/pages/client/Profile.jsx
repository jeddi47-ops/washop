    ...
    <div className="min-h-screen pt-20 pb-10 px-4 animate-fade-in" data-testid="client-profile">
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <span className="inline-block mt-1 text-xs bg-white/5 px-3 py-1 rounded-full text-gray-400">{user?.role}</span>
        </div>
        ...
        <div className="glass p-5 space-y-4">
          ...
          <div>
            <label className="text-sm text-gray-400 mb-1 block">Confirmer</label>
